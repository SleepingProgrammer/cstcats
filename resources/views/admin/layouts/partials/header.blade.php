<header class="site-header">
  <a href="#" class="brand-main">
    <img src="{{asset('/assets/admin/img/logo-horizontal-white.png')}}" id="logo-desk" alt="Laraspace Logo" class="d-none d-md-inline ">
    <img src="{{asset('/assets/admin/img/logo-horizontal.png')}}" id="logo-mobile" alt="Laraspace Logo" class="d-md-none">
  </a>
  <a href="#" class="nav-toggle">
    ...
    <ul class="action-list">
      ...
      <li>
        <a href="/logout"><i class="icon-fa icon-fa-sign-out"></i> Logout</a>
      </li>
      <!--
        <li>
